  ...
  <div class="align-items-center mt-2">
      ...
      <div class="col col-12">
        <div class="w-100">
          ...
          <input
            ...
            :class="{
              'is-invalid': !modelValue.title.valid && modelValue.title.touched,
            }"
    ...
    <div class="row mt-2" :class="{ 'align-items-center': isEdit }">
      <div :class="{ 'col-6': !isEdit, 'col-4': isEdit }">
        <div class="w-100">
          <label for="topic"> Тема презентации* </label>
          <ui-select
            id="topic"
            :value="modelValue.topic.value"
            :class="{
              'is-invalid': !modelValue.topic.valid && modelValue.topic.touched,
            }"
          ...
          <div class="help-text">*Обязательно</div>
          <div class="invalid-feedback">Выберите тему презентации</div>
        </div>
      </div>
